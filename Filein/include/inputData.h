...
class inputData
{
    public:
        ...
        int wallSet; //we may not need...we need.....
        int painting;
        int guards;
        int wallNumber;
        ...
        std::vector< std::vector<int> > get_wallSetVector(std::string);

        std::vector< std::vector<int> > get_paintVector(std::string);
        std::vector< std::vector<int> > get_guardVector(std::string);
        std::vector< std::vector<int> > get_wallNumberVector(std::string); //not neccessary

        void print_wallSet(std::vector< std::vector<int> >);
